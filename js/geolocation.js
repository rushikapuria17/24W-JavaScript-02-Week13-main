...
function success(position){
    ...
    //const url = `https://www.openstreetmap.org/#map=19/${position.coords.latitude}/${position.coords.longitude}`;
    const url = `https://www.google.com/maps/@${position.coords.latitude},${position.coords.longitude},17z?entry=ttu`;
